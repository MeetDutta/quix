...
export default function ExamHeaderHUD({
  ...
  return (
    <header className="sticky top-0 z-40 bg-[#FFFFFF]/95 dark:bg-[#171615]/95 backdrop-blur-md border-b border-[#E5E0D8] dark:border-[#292524] shadow-xs">
        ...
        <div className="bg-amber-500/10 dark:bg-amber-500/20 border-b border-amber-500/30 px-4 py-1.5 flex items-center justify-between text-xs text-amber-900 dark:text-amber-300">
          ...
          {onExitSimulation && (
            <button
              ...
              className="px-2.5 py-0.5 rounded bg-amber-600 hover:bg-amber-700 text-white font-bold text-[11px] flex items-center gap-1 transition-all"
            >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-3 flex items-center justify-between gap-4">
        ...
        <div className="min-w-0 flex items-center gap-3">
          <div className="h-9 w-9 rounded-lg bg-[#C84B18]/10 text-[#C84B18] dark:bg-[#EA580C]/15 dark:text-[#EA580C] flex items-center justify-center font-bold font-serif text-base shrink-0">
            EQ
          </div>
          <div className="truncate">
            ...
            <p className="text-[11px] text-[#716D67] dark:text-[#A8A29E] truncate">
              Candidate: <span className="font-semibold text-[#242321] dark:text-[#F5F5F4]">{candidateName}</span>
            </p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2">
          ...
          >
            <Timer className={`h-4 w-4 ${isCriticalTime ? "text-rose-600 animate-spin" : isLowTime ? "text-amber-600" : "text-[#C84B18]"}`} />
        ...
        <div className="flex items-center gap-2 sm:gap-3 shrink-0">
          ...
          {tabSwitchCount > 0 && (
            <div className="flex items-center gap-1 px-2 py-1 rounded bg-rose-100 text-rose-800 dark:bg-rose-950/40 dark:text-rose-300 text-[11px] font-bold border border-rose-300 dark:border-rose-800" title={`${tabSwitchCount}/3 tab switches recorded`}>
          ...
          <button
            ...
            className="p-2 rounded-lg border border-[#E5E0D8] dark:border-[#292524] bg-white dark:bg-[#171615] text-[#716D67] hover:text-[#242321] dark:hover:text-white transition-all"
